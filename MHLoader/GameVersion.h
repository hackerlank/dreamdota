...
namespace GameVersion {
	...
	struct VersionOffsetType {
		...
		uint32_t invoker_offset;
	};
	
	static VersionOffsetType VersionOffsets[] = {
		{6374, 0x3A21C0 + 0x20, 0x967A3C, 0x52E190, 0xAE8454},
		{6378, 0x3A21C0 + 0x20, 0x967A54, 0x52E150, 0xAE8454},
		{6384, 0x3A2220 + 0x20, 0x967A54, 0x52E1B0, 0xAE8454},
		{6387, 0x3A2280 + 0x20, 0x967A54, 0x52E210, 0xAE8454},
		{6397, 0x3A1510 + 0x20, 0x9558FC, 0x52D4E0, 0xAD15F4},
		{6401, 0x3A1740 + 0x20, 0x9558FC, 0x52D710, 0xAD15F4}
	};
				...
				if (ReadRemoteMemory(process, (void*)device_vtable, &v0, 4, &bytes_read) && bytes_read == 4) {
					...
					if (ReadRemoteMemory(process, (void*)base, mz, 2, &bytes_read) && 
						...
						if (ReadRemoteMemory(process, (void*)(base + VersionOffsets[i].version_offset), &version, 4, &bytes_read) && 
							...
							result->invoker = (void*)(base + VersionOffsets[i].invoker_offset);
