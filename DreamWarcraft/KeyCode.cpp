...
namespace KEYCODE {
	...
	{
		int locale = (int)LOWORD((DWORD)GetKeyboardLayout(0));
		...
		//custom
		case KEY_MOUSE_LEFT:
			return (const char *)StringManager::GetString(STR::KEYCODE_MOUSELEFT);
		case KEY_MOUSE_RIGHT:
			return (const char *)StringManager::GetString(STR::KEYCODE_MOUSERIGHT);
		case KEY_MOUSE_MIDDLE:
			return (const char *)StringManager::GetString(STR::KEYCODE_MOUSEMIDDLE);
		case KEY_MOUSE_X1:
			return (const char *)StringManager::GetString(STR::KEYCODE_MOUSEX1);
		case KEY_MOUSE_X2:
			return (const char *)StringManager::GetString(STR::KEYCODE_MOUSEX2);
		case KEY_MOUSE_SCROLL_DOWN:
			return (const char *)StringManager::GetString(STR::KEYCODE_WHEELDOWN);
		case KEY_MOUSE_SCROLL_UP:
			return (const char *)StringManager::GetString(STR::KEYCODE_WHEELUP);
