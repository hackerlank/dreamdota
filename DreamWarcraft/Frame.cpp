...
void Frame::setAbsolutePosition ( uint32_t originPos, float absoluteX, float absoluteY )
{
...
void Frame::setRelativePosition ( uint32_t originPos, IUIObject* target, uint32_t toPos, float relativeX, float relativeY )
{
	setRelativePosition(originPos, target->getFrame(), toPos, relativeX, relativeY);
}

void Frame::setRelativePosition ( uint32_t originPos, UILayoutFrame* target, uint32_t toPos, float relativeX /* = 0 */, float relativeY /* = 0 */ )
{
